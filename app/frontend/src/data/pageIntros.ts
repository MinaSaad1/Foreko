...
export const PAGE_INTROS: Record<PageIntroKey, PageIntroContent> = {
  ...
  operations: {
    title: "From ad-hoc analysis to production",
    summary:
      "Annotate important dates, schedule refreshes, set up alerts, share reports, and export to PDF.",
    whenToUse:
      "Once you've got a forecast you trust and want to keep it current and shareable without manual work.",
    businessQuestions: [
      "Can I auto-refresh this forecast every night?",
      "Can Slack ping me when an anomaly fires?",
      "Can I share a read-only link with stakeholders?",
    ],
    relatedTerms: ["schedule", "alert-rule", "annotation", "drift"],
  },
  glossary: {
