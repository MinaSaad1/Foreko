...
export function ConnectionForm({ onSaved }: ConnectionFormProps) {
 ...
 <input
 className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.name}
 ...
 <select
 className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.dialect}
 ...
 <input
 className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.host ??""}
 ...
 <input
 type="number"className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.port ??""}
 onChange={(e) =>
 update({
 ...
 <input
 className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.database}
 ...
 <input
 className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.username ??""}
 ...
 <input
 type="password"className="border border-border bg-bg-surface px-3 py-2 text-text-primary"value={form.password ??""}
