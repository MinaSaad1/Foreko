...
export function TablePicker({ connection, onBack, onImported }: TablePickerProps) {
 ...
 <button
 type="button"onClick={() => setSql(defaultSelectSql(t))}
 ...
 rows={8}
 className="border border-border bg-bg-surface px-3 py-2 font-mono text-sm text-text-primary"placeholder="SELECT date, value FROM sales ORDER BY date"
 />
 </label>
 ...
 {preview && (
 <div className="border border-border/60 bg-bg-surface p-3 text-xs text-text-muted">
 <p>
