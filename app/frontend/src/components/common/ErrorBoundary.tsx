...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
 ...
 console.error("[Tempolith] render error", error, info.componentStack);
 }
 ...
 <div className="max-w-xl space-y-4 border border-anomaly/50 bg-bg-surface p-6 shadow-[var(--shadow-elev-1)]">
 <p className="font-mono text-[10px] uppercase tracking-widest text-anomaly">
 Something broke
 </p>
 <h1 className="font-display text-2xl font-semibold text-text-primary">
 Tempolith hit an unexpected error
 </h1>
