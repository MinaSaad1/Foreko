...
export function Popover({
 ...
 className={`absolute z-50 w-72 border border-border/80 bg-bg-surface/95 px-4 py-3 text-sm text-text-primary shadow-[var(--shadow-elev-2)] ${PLACEMENT_CLASSES[placement]} ${panelClassName}`}
 >
