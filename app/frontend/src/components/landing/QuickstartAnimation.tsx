...
export function QuickstartAnimation() {
 ...
 <svg
 viewBox="0 0 480 140"xmlns="http://www.w3.org/2000/svg"className="w-full h-32"aria-hidden="true"
 >
 {/* === CSV icon (x: 10-120) === */}
 <g transform="translate(16 22)">
 <rect
 x="0"y="0"width="92"height="96"rx="0"className="fill-bg-elevated/60 stroke-accent/40"strokeWidth="1"
 />
 {/* Header row */}
 <rect x="0"y="0"width="92"height="14"className="fill-accent/20" />
 <text
 x="6"y="10"className="fill-accent font-mono"fontSize="7"
 >
 date
 </text>
 <text
 x="40"y="10"className="fill-accent font-mono"fontSize="7"
 >
 sales
 </text>
 <text
 x="68"y="10"className="fill-accent font-mono"fontSize="7"
 >
 temp
 </text>
 ...
 key={i}
 x="4"y={y}
 className="fill-text-secondary font-mono"fontSize="6"
 >
 2024-0{i + 1}
 </text>
 ))}
 ...
 <path
 d="M0 8 L40 8 M30 2 L40 8 L30 14"className="stroke-accent"strokeWidth="1.5"fill="none"strokeLinecap="square"strokeLinejoin="miter"
 />
 </g>
 ...
 {/* Frame */}
 <rect
 x="0"y="0"width="284"height="100"className="fill-bg-base/40 stroke-border/80"strokeWidth="1"
 />
 {/* Gridlines */}
 {[25, 50, 75].map((y) => (
 <line
 ...
 x1="0"x2="284"y1={y}
 y2={y}
 className="stroke-border/40"strokeWidth="0.5"strokeDasharray="2 4"
 />
 ))}
 {/* Historical segment (solid, always visible to ground the scene) */}
 <polyline
 points="6,72 26,64 46,70 66,58 86,52 106,60 126,48"fill="none"className="stroke-text-muted"strokeWidth="1.5"strokeLinecap="square"strokeLinejoin="miter"
 />
 {/* Forecast band (uncertainty) */}
 <path
 className="qs-band fill-accent/40"d="M126 48
 ...
 <polyline
 className="qs-chart-line stroke-accent"points="126,48 146,42 166,36 186,32 206,26 226,22 246,18 266,14"fill="none"strokeWidth="1.8"strokeLinecap="square"strokeLinejoin="miter"
 />
 {/* Forecast endpoint dot */}
 <circle cx="266"cy="14"r="3"className="qs-dot fill-accent" />
 {/* Labels */}
 <text
 x="6"y="96"className="fill-text-muted font-mono"fontSize="7"
 >
 HISTORY
 </text>
 <text
 x="180"y="96"className="fill-accent font-mono"fontSize="7"
 >
 FORECAST · P10-P90
 </text>
 </g>
