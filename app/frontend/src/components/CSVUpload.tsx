...
export function CSVUpload({ onUploaded }: CSVUploadProps) {
 ...
 onDrop,
 accept: {"text/csv": [".csv"],"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet": [".xlsx"],"application/vnd.ms-excel": [".xls"],"application/octet-stream": [".parquet"],"application/json": [".json"],"application/x-ndjson": [".jsonl",".ndjson"],
 },
 maxFiles: 1,
 multiple: false,
 });
 ...
 :"border-border/60 bg-bg-surface hover:border-accent/60 hover:bg-accent/10 hover:shadow-[0_0_20px_rgb(var(--color-accent)/0.2)]"
 }`}
 >
 <input {...getInputProps()} />
 ...
 {error && (
 <div className="mt-3 border border-anomaly/30 bg-anomaly/10 px-3 py-2 space-y-2">
