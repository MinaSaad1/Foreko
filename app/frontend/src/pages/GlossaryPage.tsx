...
export function GlossaryPage() {
 ...
 Every term Tempolith surfaces, in plain English, with the definition and what it
 ...
 placeholder="Search terms, definitions, or aliases..."className="flex-1 min-w-[240px] border border-border bg-bg-elevated px-3 py-2 text-sm text-text-primary focus:border-accent"
 />
 ...
 <nav
 aria-label="Glossary categories"className="hidden lg:block sticky top-20 self-start space-y-1"
 >
 ...
 key={term.key}
 id={`term-${term.key}`}
 className="rounded-panel border border-border/60 bg-bg-surface p-4 scroll-mt-20"
 >
 ...
 <div className="mt-2 border border-accent/30 bg-accent/5 px-2 py-1.5">
