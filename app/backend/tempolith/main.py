"""FastAPI application factory for Tempolith."""
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    # Model cache lives under the Tempolith storage dir (real file copies,
    ...
    if settings.fake_models:
        # Test-only path, off unless TEMPOLITH_FAKE_MODELS is set. The browser
        ...
        logger.warning(
            "TEMPOLITH_FAKE_MODELS is set: forecasts are deterministic stand-ins, "
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        version=__version__,
        description=(
            "Tempolith, a local-first time-series forecasting workbench. "
