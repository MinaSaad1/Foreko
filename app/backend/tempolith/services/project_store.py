...
referenced here by path and hash. See :mod:`tempolith.services.project_artifacts`.

The schema itself is owned by :mod:`tempolith.services.migrations` (migration 2).
"""
