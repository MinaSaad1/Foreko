...
async def detect_multi_method(
    ...
    _key, cached = store.cache_lookup(request.dataset_id, "anomaly_methods", request)
    ...
    store.cache_put(request.dataset_id, "anomaly_methods", _key, result)
    return result
...
async def detect_changepoints(
    ...
    _key, cached = store.cache_lookup(request.dataset_id, "changepoints", request)
    if cached is not None:
        return cached
    ...
    store.cache_put(request.dataset_id, "changepoints", _key, result)
    return result
