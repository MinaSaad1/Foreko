...
Foreko never writes passwords to disk. The plaintext DB password goes through
...
Service name convention:
    foreko-connection-<connection_id>   (username = DB username)
...
_SERVICE_PREFIX = "foreko-connection-"
