...
class Settings(BaseSettings):
    ...
    Override any field via ``FOREKO_<FIELD>`` environment variables.
    """
    ...
    storage_dir: Path = Field(
        default_factory=lambda: Path.home() / ".foreko",
    ...
    def db_path(self) -> Path:
        return self.data_dir / "foreko.db"
