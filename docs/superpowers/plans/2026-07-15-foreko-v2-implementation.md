# Foreko V2.0 Forecast Projects Implementation Plan
...
**Architecture:** Add an additive project domain beside the existing V1 analyses. SQLite stores versioned metadata and immutable run manifests, while large artifacts remain under `~/.foreko/projects/<project_id>/`. The React application becomes project-first through a Forecast Studio shell, while existing forecasting services remain the execution engines behind new orchestration boundaries.
...
- `app/backend/foreko/services/ensemble_policy.py`: constrained out-of-fold ensemble weights and promotion guardrails.
...
- Modify: `app/backend/foreko/services/store.py:86-311`
- Modify: `app/backend/foreko/deps.py:45-52`
- Modify: `app/backend/foreko/settings.py`
...
Expected: collection fails with `ModuleNotFoundError: No module named 'foreko.services.project_store'`.
...
```powershell
git add app/backend/foreko/schemas/project.py app/backend/foreko/services/project_store.py app/backend/foreko/services/project_artifacts.py app/backend/foreko/services/store.py app/backend/foreko/deps.py app/backend/foreko/settings.py app/backend/tests/unit/test_project_store.py
...
- Modify: `app/backend/foreko/main.py:133-212`
...
```powershell
git add app/backend/foreko/services/project_workflow.py app/backend/foreko/routers/projects.py app/backend/foreko/main.py app/backend/tests/unit/test_projects_router.py app/backend/tests/unit/test_project_workflow.py
...
Expected: collection fails because `foreko.services.preparation` does not exist.
...
```powershell
git add app/backend/foreko/services/preparation.py app/backend/foreko/services/transformations.py app/backend/foreko/routers/project_jobs.py app/backend/tests/unit/test_preparation.py app/frontend/src/components/project/PrepareStage.tsx app/frontend/src/components/project/PreparationRecipeEditor.tsx app/frontend/src/components/project/__tests__/PrepareStage.test.tsx app/frontend/src/pages/ForecastStudioPage.tsx
...
- Modify: `app/backend/foreko/services/backtest.py`
- Modify: `app/backend/foreko/routers/project_jobs.py`
...
```powershell
git add app/backend/foreko/services/validation_policy.py app/backend/foreko/services/ensemble_policy.py app/backend/foreko/services/backtest.py app/backend/foreko/routers/project_jobs.py app/backend/tests/unit/test_validation_policy.py app/backend/tests/unit/test_ensemble_policy.py app/frontend/src/components/project/ValidateStage.tsx app/frontend/src/components/project/ValidationLeaderboard.tsx app/frontend/src/components/project/PortfolioExceptionsTable.tsx app/frontend/src/components/project/__tests__/ValidateStage.test.tsx
...
```powershell
git add app/backend/foreko/services/factor_plan.py app/backend/foreko/services/forecaster.py app/backend/foreko/services/scenarios.py app/backend/foreko/routers/project_jobs.py app/backend/tests/unit/test_factor_plan.py app/frontend/src/components/project/ForecastStage.tsx app/frontend/src/components/project/PlanStage.tsx app/frontend/src/components/project/FutureFactorGrid.tsx app/frontend/src/components/project/__tests__/FutureFactorGrid.test.tsx app/frontend/src/pages/ProjectScenariosPage.tsx
...
```powershell
git add app/backend/foreko/services/actuals.py app/backend/foreko/services/project_store.py app/backend/foreko/routers/project_jobs.py app/backend/tests/unit/test_actuals.py app/frontend/src/components/project/ReviewStage.tsx app/frontend/src/components/project/IssuedForecastBanner.tsx app/frontend/src/components/project/AccuracySummary.tsx app/frontend/src/components/project/__tests__/ReviewStage.test.tsx app/frontend/src/pages/ProjectAccuracyPage.tsx
...
- Modify: `app/backend/foreko/routers/project_jobs.py`
- Modify: `app/backend/foreko/routers/system.py`
...
```powershell
git add app/backend/foreko/services/exports.py app/backend/foreko/routers/project_jobs.py app/backend/foreko/routers/system.py app/backend/tests/unit/test_project_exports.py app/backend/tests/unit/test_system_endpoints.py app/frontend/src/pages/ProjectRunsPage.tsx app/frontend/src/components/project/RunManifestDrawer.tsx app/frontend/src/components/project/__tests__/RunManifestDrawer.test.tsx app/frontend/src/App.tsx
...
Run: `cd app/frontend; npx playwright test e2e/foreko-v2-project.spec.ts --project=chromium`
...
```powershell
git add app/frontend/e2e/foreko-v2-project.spec.ts app/frontend/public/samples/multi_series_demand_demo.csv app/frontend/playwright.config.ts app/backend/tests/conftest.py .github/workflows/ci.yml
...
Add exact glossary entries for Forecast Project, Project Revision, Project Run, Issued Forecast, Post-issue Accuracy, MASE, WAPE, Signed Bias, and Coverage. Update Privacy with every new SQLite table and `~/.foreko/projects/` subdirectory.
...
Check the acceptance criteria in `docs/superpowers/specs/2026-07-15-foreko-v2-design.md` one by one. Add a release-note evidence line for project persistence, preparation immutability, rolling selection, multi-series policies, explicit future factors, immutable issuance, actual matching, local-only behavior, V1 compatibility, and reproducible reopen.
...
- A manual local smoke test using the Windows desktop packaging path or a documented reason it must run in the separate `foreko-desktop` repository.
